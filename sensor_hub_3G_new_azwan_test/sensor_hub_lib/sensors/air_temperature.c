...
// Initalise PM25
void init_airtemperature_control(qm_gpio_port_config_t *cfg)
{
...
// Initialise UART
void airtemperature_init(qm_uart_config_t *cfg)
{
...
//		}
	...
	//QM_PRINTF("Data_raws: %d\n", uart1_raw[0]);
		...
		airtemperature_int=(x[0]*100)+(x[1]*100)+x[2];
		//QM_PRINTF("haha: %d", airtemperature_int);
