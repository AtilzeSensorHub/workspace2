...
int main(void)
{
	...
	while (1)
	{
		...
		case STATE_TX:
			...
			// Next state
			state = STATE_TX;//change to RX if requires RX to be executed after TX state. if requires sleep, change to SLEEP state.
