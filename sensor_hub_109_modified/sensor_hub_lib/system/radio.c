...
void radio_send_data(uint16_t *send_data)
{
    ...
    if(RELAY_SHIELD!=0)
    {
    	if(RELAY_PUMP_B!=0)
		{
    		...
    		QM_PUTS("start downlink");
    		downlink_pump_statusB0=get_downlink_status_pumpB(statusB0);
...
//			downlink_pump_statusB1=get_downlink_status_pumpB(statusB1);
...
//	//ends
    ...
    if(RELAY_SHIELD!=0)
    {
    	if(RELAY_PUMP_B!=0)
    	{
			...
			QM_PUTS("start downlink");
			downlink_pump_statusB2=get_downlink_status_pumpB(statusB2);
			QM_PRINTF("Downlink status: %s\n", downlink_pump_statusB2);
    	}
...
//			downlink_pump_statusB3=get_downlink_status_pumpB(statusB3);
...
//	//ends
    ...
    if(RELAY_SHIELD!=0)
    {
    	if(RELAY_PUMP_B!=0)
        {
			...
			QM_PUTS("start downlink");
			downlink_pump_statusB4=get_downlink_status_pumpB(statusB4);
...
//			downlink_pump_statusB5=get_downlink_status_pumpB(statusB5);
...
//   	//ends
    ...
    if(RELAY_SHIELD!=0)
	{
    	if(RELAY_PUMP_B!=0)
		{
			...
			QM_PUTS("start downlink");
			downlink_pump_statusB6=get_downlink_status_pumpB(statusB6);
...
//			downlink_pump_statusB7=get_downlink_status_pumpB(statusB7);
...
//	//ends
    ...
    if(RELAY_SHIELD!=0)
	{
    	if(RELAY_PUMP_B!=0)
		{
			...
			QM_PUTS("start downlink");
			downlink_pump_statusB8=get_downlink_status_pumpB(statusB8);
...
//			downlink_pump_statusB9=get_downlink_status_pumpB(statusB9);
...
//	//ends
    ...
    if(RELAY_SHIELD!=0)
	{
    	if(RELAY_PUMP_B!=0)
		{
			...
			QM_PUTS("start downlink");
			downlink_pump_statusB10=get_downlink_status_pumpB(statusB10);
...
//			downlink_pump_statusB11=get_downlink_status_pumpB(statusB11);
...
//	//ends
    ...
    if(RELAY_SHIELD!=0)
	{
    	if(RELAY_PUMP_B!=0)
		{
			...
			QM_PUTS("start downlink");
			downlink_pump_statusB12=get_downlink_status_pumpB(statusB12);
...
//			downlink_pump_statusB13=get_downlink_status_pumpB(statusB13);
...
//	//ends
	...
	if(RELAY_SHIELD!=0)
	{
		if(RELAY_PUMP_B!=0)
		{
			...
			QM_PUTS("start downlink");
			downlink_pump_statusB14=get_downlink_status_pumpB(statusB14);
...
//			downlink_pump_statusB15=get_downlink_status_pumpB(statusB15);
