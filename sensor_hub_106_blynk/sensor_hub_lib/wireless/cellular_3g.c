...
//  // Send ATDL putsreq.com
    ...
    uint8_t at6[] = "ATDL private-anon-cf8ff80912-blynkapi.apiary-proxy.com\r\n";
...
{
	//uint8_t cmd0[] = "POST /api/v1.6/devices/devicex/?token=BBFF-mE3Q3YAXYtpAuXpUKMDFntJZBV2jgt HTTP/1.1\r\n";
	//uint8_t cmd0[] = "POST /api/v1.6/devices/devicex HTTP/1.1\r\n";
	uint8_t cmd0[] = "POST /080ada1db7ea48c1ad4342f4db741744/update/V0 HTTP/1.1\r\n";
	uint8_t cmd1[] = "Host: private-anon-cf8ff80912-blynkapi.apiary-proxy.com\r\n";
	...
	uint8_t cmd6[] ="Content-Length: 10\r\n\r\n";
	uint8_t cmd7[] = "[\"87\"]\r\n\r\n";
