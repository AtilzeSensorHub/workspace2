...
int get_420ma_sensor ()
{
	 ...
	 //sensor_420ma_val=  (adc_output/4096)*5000;   //maximum we set the EC meter to 5000us/cm
	 ...
	 else if (adc_output>=4036)
	 {
	 	sensor_420ma_val = 5000;
	 }

	 else
	 {
		 sensor_420ma_val=  ((adc_output-808)/(4036-808))*5000;
	 }

	 sensor_420ma_dec = (int)(sensor_420ma_val);
