...
//  // Send ATDL putsreq.com
    ...
    uint8_t at6[] = "ATDL things.ubidots.com\r\n";
...
void cellular_3g_send(const qm_uart_t uart)
{
	...
	uint8_t cmd0[] = "POST /api/v1.6/devices/devicex/?token=A1E-kvuGQMIEMhwiHcUGI1MQNZE0n0wHqJ HTTP/1.1\r\n";
	...
	uint8_t cmd6[] ="Content-Length: 18\r\n\r\n";
	uint8_t cmd7[] = "{\"variablex\":87}\r\n\r\n";
