...
// Applications
#define SENSOR_TYPE         SMART_AGRI0   // Applications
#define SLEEP_TIME          80            // Deep sleep time in seconds
...
// POST/GET RESTAPI
#define POST_URL             "/api/v1.6/devices/devicex"   // PLS CLEAN THE PROJECT
#define POST_HOST            "http://things.ubidots.com"   // PLS CLEAN THE PROJECT
